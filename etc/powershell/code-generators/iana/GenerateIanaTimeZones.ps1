...
#   - etc/powershell/code-generators/iana/iana-tz-zone-info/zone1970.tab is up-to-date.
#   - etc/powershell/code-generators/iana/iana-tz-zone-info/DefaultIanaTimeZoneData.template.cs is up-to-date.
# =================================================================================================
...
$generatedDir = Join-Path $repoRoot "etc\artifacts\code-generators\iana"

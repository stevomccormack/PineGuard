...
/// <summary>
/// Guard clauses for date-time temporal validation.
/// </summary>
/// <seealso href="https://pineguard.ai/docs/guard/date-time">Guard DateTime documentation</seealso>
public static class GuardDateTimeClauses
{
    /// <summary>
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.Between"/>
    public static DateTime NotBetween(this IGuardClause _,
        DateTime value,
        DateTime min,
        DateTime max,
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.NotBetween"/>
    public static DateTime Between(this IGuardClause _,
        DateTime value,
        DateTime min,
        DateTime max,
        Inclusion inclusion = Inclusion.Inclusive,
    ...
    public static DateTime OnOrAfter(this IGuardClause _,
        DateTime value,
        DateTime other,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
    ...
    public static DateTime After(this IGuardClause _,
        DateTime value,
        DateTime other,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
    ...
    public static DateTime OnOrBefore(this IGuardClause _,
        DateTime value,
        DateTime other,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
    ...
    public static DateTime Before(this IGuardClause _,
        DateTime value,
        DateTime other,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.Same"/>
    public static DateTime NotSame(this IGuardClause _,
        DateTime value,
        DateTime other,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.NotSame"/>
    public static DateTime Same(this IGuardClause _,
        DateTime value,
        DateTime other,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.Chronological"/>
    public static DateTime NotChronological(this IGuardClause _,
        DateTime start,
        DateTime end,
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.NotOverlapping"/>
    public static DateTime Overlapping(this IGuardClause _,
        DateTime start1,
        DateTime end1,
        DateTime start2,
        DateTime end2,
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.Overlapping"/>
    public static DateTime NotOverlapping(this IGuardClause _,
        DateTime start1,
        DateTime end1,
        DateTime start2,
        DateTime end2,
    ...
    /// <summary>
    /// Throws if <paramref name="value"/> violates the NotWithinDaysFromNow constraint.
    /// </summary>
    /// <param name="_">The <see cref="IGuardClause"/> entry point (used via <c>Guard.Against</c>).</param>
    /// <param name="value">The value to guard.</param>
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.WithinDaysFromNow"/>
    ...
    /// <summary>
    /// Throws if <paramref name="value"/> violates the WithinDaysFromNow constraint.
    /// </summary>
    /// <param name="_">The <see cref="IGuardClause"/> entry point (used via <c>Guard.Against</c>).</param>
    /// <param name="value">The value to guard.</param>
    /// <param name="days">The number of days for the proximity window.</param>
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.NotWithinDaysFromNow"/>
    ...
    /// <summary>
    /// Throws if <paramref name="value"/> violates the NotWithin constraint.
    /// </summary>
    /// <param name="_">The <see cref="IGuardClause"/> entry point (used via <c>Guard.Against</c>).</param>
    /// <param name="value">The value to guard.</param>
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.Within"/>
    public static DateTime NotWithin(this IGuardClause _,
        DateTime value,
        DateTime reference,
        TimeSpan window,
        string? message = null,
    ...
    /// <summary>
    /// Throws if <paramref name="value"/> violates the Within constraint.
    /// </summary>
    /// <param name="_">The <see cref="IGuardClause"/> entry point (used via <c>Guard.Against</c>).</param>
    /// <param name="value">The value to guard.</param>
    /// <param name="reference">The reference value to measure from.</param>
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.NotWithin"/>
    public static DateTime Within(this IGuardClause _,
        DateTime value,
        DateTime reference,
        TimeSpan window,
        string? message = null,
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.WithinCalendarMonths"/>
    public static DateTime NotWithinCalendarMonths(this IGuardClause _,
        DateTime value,
        DateTime reference,
        int months,
        string? message = null,
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.NotWithinCalendarMonths"/>
    public static DateTime WithinCalendarMonths(this IGuardClause _,
        DateTime value,
        DateTime reference,
        int months,
        string? message = null,
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.Weekday"/>
    public static DateTime Weekend(this IGuardClause _,
        DateTime value,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
        [CallerArgumentExpression(nameof(value))] string? paramName = null)
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.Weekend"/>
    public static DateTime Weekday(this IGuardClause _,
        DateTime value,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
        [CallerArgumentExpression(nameof(value))] string? paramName = null)
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.FirstDayOfMonth"/>
    public static DateTime NotFirstDayOfMonth(this IGuardClause _,
        DateTime value,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
        [CallerArgumentExpression(nameof(value))] string? paramName = null)
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.NotFirstDayOfMonth"/>
    public static DateTime FirstDayOfMonth(this IGuardClause _,
        DateTime value,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
        [CallerArgumentExpression(nameof(value))] string? paramName = null)
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.LastDayOfMonth"/>
    public static DateTime NotLastDayOfMonth(this IGuardClause _,
        DateTime value,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
        [CallerArgumentExpression(nameof(value))] string? paramName = null)
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.NotLastDayOfMonth"/>
    public static DateTime LastDayOfMonth(this IGuardClause _,
        DateTime value,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
        [CallerArgumentExpression(nameof(value))] string? paramName = null)
    ...
    /// <summary>
    /// Throws if <paramref name="value"/> violates the NotSameDay constraint.
    /// </summary>
    /// <param name="_">The <see cref="IGuardClause"/> entry point (used via <c>Guard.Against</c>).</param>
    /// <param name="value">The value to guard.</param>
    /// <param name="other">The value to compare against.</param>
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.SameDay"/>
    public static DateTime NotSameDay(this IGuardClause _,
        DateTime value,
        DateTime other,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
    ...
    /// <summary>
    /// Throws if <paramref name="value"/> violates the SameDay constraint.
    /// </summary>
    /// <param name="_">The <see cref="IGuardClause"/> entry point (used via <c>Guard.Against</c>).</param>
    /// <param name="value">The value to guard.</param>
    /// <param name="other">The value to compare against.</param>
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.NotSameDay"/>
    public static DateTime SameDay(this IGuardClause _,
        DateTime value,
        DateTime other,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
    ...
    /// <summary>
    /// Throws if <paramref name="value"/> violates the NotUtc constraint.
    /// </summary>
    /// <param name="_">The <see cref="IGuardClause"/> entry point (used via <c>Guard.Against</c>).</param>
    /// <param name="value">The value to guard.</param>
    /// <param name="message">An optional custom error message.</param>
    ...
    public static DateTime NotUtc(this IGuardClause _,
        DateTime value,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
        [CallerArgumentExpression(nameof(value))] string? paramName = null)
    ...
    /// <summary>
    /// Throws if <paramref name="value"/> violates the Utc constraint.
    /// </summary>
    /// <param name="_">The <see cref="IGuardClause"/> entry point (used via <c>Guard.Against</c>).</param>
    /// <param name="value">The value to guard.</param>
    /// <param name="message">An optional custom error message.</param>
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.NotUtc"/>
    public static DateTime Utc(this IGuardClause _,
        DateTime value,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
        [CallerArgumentExpression(nameof(value))] string? paramName = null)
    ...
    /// <summary>
    /// Throws if <paramref name="value"/> violates the NotLocal constraint.
    /// </summary>
    /// <param name="_">The <see cref="IGuardClause"/> entry point (used via <c>Guard.Against</c>).</param>
    /// <param name="value">The value to guard.</param>
    /// <param name="message">An optional custom error message.</param>
    ...
    public static DateTime NotLocal(this IGuardClause _,
        DateTime value,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
        [CallerArgumentExpression(nameof(value))] string? paramName = null)
    ...
    /// <summary>
    /// Throws if <paramref name="value"/> violates the Local constraint.
    /// </summary>
    /// <param name="_">The <see cref="IGuardClause"/> entry point (used via <c>Guard.Against</c>).</param>
    /// <param name="value">The value to guard.</param>
    /// <param name="message">An optional custom error message.</param>
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.NotLocal"/>
    public static DateTime Local(this IGuardClause _,
        DateTime value,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
        [CallerArgumentExpression(nameof(value))] string? paramName = null)
    ...
    /// <summary>
    /// Throws if <paramref name="value"/> violates the NotUnspecified constraint.
    /// </summary>
    /// <param name="_">The <see cref="IGuardClause"/> entry point (used via <c>Guard.Against</c>).</param>
    /// <param name="value">The value to guard.</param>
    /// <param name="message">An optional custom error message.</param>
    ...
    public static DateTime NotUnspecified(this IGuardClause _,
        DateTime value,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
        [CallerArgumentExpression(nameof(value))] string? paramName = null)
    ...
    /// <summary>
    /// Throws if <paramref name="value"/> violates the Unspecified constraint.
    /// </summary>
    /// <param name="_">The <see cref="IGuardClause"/> entry point (used via <c>Guard.Against</c>).</param>
    /// <param name="value">The value to guard.</param>
    /// <param name="message">An optional custom error message.</param>
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.NotUnspecified"/>
    public static DateTime Unspecified(this IGuardClause _,
        DateTime value,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
        [CallerArgumentExpression(nameof(value))] string? paramName = null)
    ...
    /// <summary>
    /// Throws if <paramref name="value"/> violates the NotExplicitKind constraint.
    /// </summary>
    /// <param name="_">The <see cref="IGuardClause"/> entry point (used via <c>Guard.Against</c>).</param>
    /// <param name="value">The value to guard.</param>
    /// <param name="message">An optional custom error message.</param>
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.ExplicitKind"/>
    public static DateTime NotExplicitKind(this IGuardClause _,
        DateTime value,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
        [CallerArgumentExpression(nameof(value))] string? paramName = null)
    ...
    /// <summary>
    /// Throws if <paramref name="value"/> violates the ExplicitKind constraint.
    /// </summary>
    /// <param name="_">The <see cref="IGuardClause"/> entry point (used via <c>Guard.Against</c>).</param>
    /// <param name="value">The value to guard.</param>
    /// <param name="message">An optional custom error message.</param>
    ...
    /// <paramref name="exceptionCreator"/> is provided.
    /// </exception>
    /// <seealso cref="MustDateTimeClauses.NotExplicitKind"/>
    public static DateTime ExplicitKind(this IGuardClause _,
        DateTime value,
        string? message = null,
        Func<Exception>? exceptionCreator = null,
        [CallerArgumentExpression(nameof(value))] string? paramName = null)

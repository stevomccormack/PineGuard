...
public static class SqlDateTimeUtility
{
    public static bool TryCreateSqlDateOnly(DateOnly? value, out DateOnly sqlDate)
    {
        ...
        if (!RuleComparison.IsBetween(dt, SqlDateTimeRules.MinValue, SqlDateTimeRules.MaxValue, RangeInclusion.Inclusive))
            return false;
    ...
    public static bool TryCreateSqlDateTime(DateTimeOffset? value, out DateTimeOffset sqlDateTime)
    {
        ...
        if (!RuleComparison.IsBetween(utc, SqlDateTimeRules.MinValue, SqlDateTimeRules.MaxValue, RangeInclusion.Inclusive))
            return false;
    ...
    public static bool TryCreateSqlDateTime(DateTime? value, out DateTime sqlDateTime)
    {
        ...
        var v = value.Value;
        if (!RuleComparison.IsBetween(v, SqlDateTimeRules.MinValue, SqlDateTimeRules.MaxValue, RangeInclusion.Inclusive))
            return false;

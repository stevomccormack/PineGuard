...
public static class UriUtility
{
    ...
    public static bool TryParseFilePath(string? value, out string path)
    {
        ...
        //
        // IsWindowsAbsolutePath is evaluated up front rather than inline: it is a pure predicate,
        // and short-circuiting made it unreachable on Windows, where IsPathFullyQualified already

...
/// <summary>
/// Provides dictionary access and query utility methods for <see cref="IDictionary{TKey,TValue}"/>.
/// </summary>
/// <seealso href="https://pineguard.ai/docs/utils/dictionary">Dictionary Utility documentation</seealso>
public static class DictionaryUtility
{
    /// <summary>
    /// Attempts to get the count of entries in the dictionary.
    /// </summary>
    ...
    /// <summary>
    /// Attempts to retrieve a value by key from the dictionary.
    /// </summary>
    /// <typeparam name="TKey">The key type.</typeparam>
    /// <typeparam name="TValue">The value type.</typeparam>
    /// <param name="dictionary">The dictionary. If <see langword="null"/>, returns <see langword="false"/>.</param>
    ...
    /// <summary>
    /// Attempts to retrieve a key-value pair by key from the dictionary.
    /// </summary>
    /// <typeparam name="TKey">The key type.</typeparam>
    /// <typeparam name="TValue">The value type.</typeparam>
    /// <param name="dictionary">The dictionary. If <see langword="null"/>, returns <see langword="false"/>.</param>

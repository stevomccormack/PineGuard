...
public static class GuidRules
{
    ...
    /// </summary>
    /// <param name="value">The value to validate. If <see langword="null"/>, returns <see langword="true"/>.</param>
    /// <returns>
    /// <see langword="true"/> if <paramref name="value"/> is <see langword="null"/> or equal to
    ...
    /// </example>
    /// <seealso href="https://pineguard.ai/docs/rules/guid">Guid Rules documentation</seealso>
    public static bool IsEmpty(Guid? value) => value is null || value.Value == Guid.Empty;

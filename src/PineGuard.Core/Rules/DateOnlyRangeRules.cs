...
/// <summary>
/// Provides validation predicates for <see cref="DateOnlyRange"/> structs.
/// </summary>
/// <seealso href="https://pineguard.ai/docs/rules/dateonly">Date Rules documentation</seealso>
public static class DateOnlyRangeRules
{
    /// <summary>
    /// Determines whether the specified date range is chronological (start &lt;= end).
    /// </summary>
    ...
    /// <summary>
    /// Determines whether the specified date falls within the given range.
    /// </summary>
    ...
    /// otherwise, <see langword="false"/>.
    /// </returns>
    public static bool Contains(DateOnlyRange? range, DateOnly? value, Inclusion inclusion = Inclusion.Inclusive)
    {

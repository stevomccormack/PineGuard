...
using TD = PineGuard.GuardClauses.UnitTests.GuardDateTimeOffsetClausesTestData;

namespace PineGuard.GuardClauses.UnitTests;

public sealed class GuardDateTimeOffsetClausesTests(ITestOutputHelper output) : BaseGuardUnitTest(output)
{
    [Theory]
    ...
    public void FutureOrPresent_BehavesAsExpected(GuardCase<DateTimeOffset> tc)
    {
        var value = tc.Value;
    ...
    public void Future_BehavesAsExpected(GuardCase<DateTimeOffset> tc)
    {
        var value = tc.Value;
    ...
    public void PastOrPresent_BehavesAsExpected(GuardCase<DateTimeOffset> tc)
    {
        var value = tc.Value;
    ...
    public void Past_BehavesAsExpected(GuardCase<DateTimeOffset> tc)
    {
        var value = tc.Value;
    ...
    public void NotBetween_BehavesAsExpected(GuardCase<(DateTimeOffset value, DateTimeOffset min, DateTimeOffset max, Inclusion inclusion)> tc)
    {
    ...
    public void Between_BehavesAsExpected(GuardCase<(DateTimeOffset value, DateTimeOffset min, DateTimeOffset max, Inclusion inclusion)> tc)
    {
        var value = tc.Value.value;
    ...
    public void OnOrAfter_BehavesAsExpected(GuardCase<(DateTimeOffset value, DateTimeOffset other)> tc)
    {
        var value = tc.Value.value;
    ...
    public void After_BehavesAsExpected(GuardCase<(DateTimeOffset value, DateTimeOffset other)> tc)
    {
        var value = tc.Value.value;
    ...
    public void OnOrBefore_BehavesAsExpected(GuardCase<(DateTimeOffset value, DateTimeOffset other)> tc)
    {
        var value = tc.Value.value;
    ...
    public void Before_BehavesAsExpected(GuardCase<(DateTimeOffset value, DateTimeOffset other)> tc)
    {
        var value = tc.Value.value;
    ...
    public void NotSame_BehavesAsExpected(GuardCase<(DateTimeOffset value, DateTimeOffset other)> tc)
    {
        var value = tc.Value.value;
    ...
    public void Same_BehavesAsExpected(GuardCase<(DateTimeOffset value, DateTimeOffset other)> tc)
    {
        var value = tc.Value.value;
    ...
    public void NotChronological_BehavesAsExpected(GuardCase<(DateTimeOffset start, DateTimeOffset end, Inclusion inclusion)> tc)
    {
    ...
    public void Overlapping_BehavesAsExpected(GuardCase<(DateTimeOffset start1, DateTimeOffset end1, DateTimeOffset start2, DateTimeOffset end2, Inclusion inclusion)> tc)
    {
    ...
    public void NotOverlapping_BehavesAsExpected(GuardCase<(DateTimeOffset start1, DateTimeOffset end1, DateTimeOffset start2, DateTimeOffset end2, Inclusion inclusion)> tc)
    {
        var start1 = tc.Value.start1;
    ...
    public void NotWithin_BehavesAsExpected(GuardCase<(DateTimeOffset value, DateTimeOffset reference, TimeSpan window)> tc)
    {
        var value = tc.Value.value;
    ...
    public void Within_BehavesAsExpected(GuardCase<(DateTimeOffset value, DateTimeOffset reference, TimeSpan window)> tc)
    {
        var value = tc.Value.value;
    ...
    public void NotWithinCalendarMonths_BehavesAsExpected(GuardCase<(DateTimeOffset value, DateTimeOffset reference, int months)> tc)
    {
        var value = tc.Value.value;
    ...
    public void WithinCalendarMonths_BehavesAsExpected(GuardCase<(DateTimeOffset value, DateTimeOffset reference, int months)> tc)
    {
        var value = tc.Value.value;
    ...
    public void Weekend_BehavesAsExpected(GuardCase<DateTimeOffset> tc)
    {
        var value = tc.Value;
    ...
    public void Weekday_BehavesAsExpected(GuardCase<DateTimeOffset> tc)
    {
        var value = tc.Value;
    ...
    public void NotFirstDayOfMonth_BehavesAsExpected(GuardCase<DateTimeOffset> tc)
    {
        var value = tc.Value;
    ...
    public void FirstDayOfMonth_BehavesAsExpected(GuardCase<DateTimeOffset> tc)
    {
        var value = tc.Value;
    ...
    public void NotLastDayOfMonth_BehavesAsExpected(GuardCase<DateTimeOffset> tc)
    {
        var value = tc.Value;
    ...
    public void LastDayOfMonth_BehavesAsExpected(GuardCase<DateTimeOffset> tc)
    {
        var value = tc.Value;

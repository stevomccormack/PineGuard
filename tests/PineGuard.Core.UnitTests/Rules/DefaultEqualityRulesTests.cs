...
public sealed class DefaultEqualityRulesTests : BaseUnitTest
{
    ...
    {
        var result = DefaultEqualityRules.IsDefault<int>(testCase.Value);
    ...
    {
        var result = DefaultEqualityRules.IsDefault<string>(testCase.Value);
        Assert.Equal(testCase.Expected, result);
    }
    ...
    {
        var result = DefaultEqualityRules.IsNullOrDefault<int>(testCase.Value);
        Assert.Equal(testCase.Expected, result);
    }
    ...
    {
        var result = DefaultEqualityRules.IsNullOrDefault<string>(testCase.Value);
        Assert.Equal(testCase.Expected, result);
    }
}

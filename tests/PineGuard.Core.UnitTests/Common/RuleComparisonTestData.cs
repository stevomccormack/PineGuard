...
public static class RuleComparisonTestData
{
    public static class Equality
    {
        ...
        public sealed record Case(string Name, (int Value, int Other) Value, bool Expected)
            : IsCase<(int Value, int Other)>(Name, Value, Expected);
    }
    ...
    public static class IsBetween
    {
        ...
        [
            ...
            new("0..0 exclusive", (0, 0, 0, Inclusion.Exclusive), false), new("min>max", (5, 10, 1, Inclusion.Inclusive), false)
        ];
        ...
        public sealed record ValidCase(string Name, (int Value, int Min, int Max, Inclusion Inclusion) Value, bool Expected)
            : IsCase<(int Value, int Min, int Max, Inclusion Inclusion)>(Name, Value, Expected);
    ...
    public static class Boundaries
    {
        ...
        public sealed record ValidCase(string Name, (int Value, int Boundary, Inclusion Inclusion) Value, (bool ExpectedGreaterThan, bool ExpectedLessThan) Expected)
            : ReturnCase<(int Value, int Boundary, Inclusion Inclusion), (bool ExpectedGreaterThan, bool ExpectedLessThan)>(Name, Value, Expected);

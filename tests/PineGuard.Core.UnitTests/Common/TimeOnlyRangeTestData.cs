...
public static class TimeOnlyRangeTestData
{
    ...
    public static class Overlaps
    {
        ...
        [
            new("partial overlap", () =>
            {
                var a = new TimeOnlyRange(new TimeOnly(10, 0), new TimeOnly(15, 0));
                var b = new TimeOnlyRange(new TimeOnly(12, 0), new TimeOnly(18, 0));
                Assert.True(a.Overlaps(b));
                Assert.True(b.Overlaps(a));
            }),
            new("contained", () =>
            {
                var outer = new TimeOnlyRange(new TimeOnly(8, 0), new TimeOnly(20, 0));
                var inner = new TimeOnlyRange(new TimeOnly(10, 0), new TimeOnly(15, 0));
            ...
            {
                var a = new TimeOnlyRange(new TimeOnly(10, 0), new TimeOnly(15, 0));
                var b = new TimeOnlyRange(new TimeOnly(10, 0), new TimeOnly(15, 0));
                Assert.True(a.Overlaps(b));
            }),
            new("no overlap strictly before", () =>
            {
                var a = new TimeOnlyRange(new TimeOnly(8, 0), new TimeOnly(10, 0));
                var b = new TimeOnlyRange(new TimeOnly(12, 0), new TimeOnly(15, 0));
                Assert.False(a.Overlaps(b));
                Assert.False(b.Overlaps(a));
            }),
            new("inclusive vs exclusive", () =>
            {
                var a = new TimeOnlyRange(new TimeOnly(10, 0), new TimeOnly(15, 0));
                var b = new TimeOnlyRange(new TimeOnly(12, 0), new TimeOnly(18, 0));
                Assert.True(a.Overlaps(b, Inclusion.Inclusive));
                Assert.True(a.Overlaps(b, Inclusion.Exclusive));
            })
        ];
    ...
    public static class Constructor
    {
        ...
        [
            ...
            new("near max to max", new TimeOnly(23, 59, 58), TimeOnly.MaxValue, TimeOnly.MaxValue.ToTimeSpan() - new TimeOnly(23, 59, 58).ToTimeSpan())
        ];
    ...
    public static class TryCreate
    {
        public static TheoryData<ValidCase> ValidCases =>
        [
            new("ok", (new TimeOnly(10, 00, 00), new TimeOnly(11, 00, 00)), true, new TimeOnlyRange(new TimeOnly(10, 00, 00), new TimeOnly(11, 00, 00)))
        ];

        public static TheoryData<ValidCase> EdgeCases =>
        [
            new("start null", (null, new TimeOnly(11, 00, 00)), false, default),
            new("end null", (new TimeOnly(10, 00, 00), null), false, default),
            new("start after end", (new TimeOnly(11, 00, 00), new TimeOnly(10, 00, 00)), false, default)
        ];

        public sealed record ValidCase(string Name, (TimeOnly? Start, TimeOnly? End) Value, bool Expected, TimeOnlyRange ExpectedOutValue)
            : TryCase<(TimeOnly? Start, TimeOnly? End), TimeOnlyRange>(Name, Value, Expected, ExpectedOutValue);

        public sealed record InvalidCase(string Name, ExpectedException ExpectedException)
            : ThrowsCase<string>(Name, Name, ExpectedException);
    }
}

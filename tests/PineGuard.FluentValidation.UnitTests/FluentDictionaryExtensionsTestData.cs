...
public static class FluentDictionaryExtensionsTestData
{
    public static class Empty
    {
        public static TheoryData<FluentCase<IDictionary<string, int>?>> Cases => F.IsEmpty.AllScenarios.ToFluentCases(s => s.Name switch
        {
    ...
    {
        public static TheoryData<FluentCase<IDictionary<string, int>?>> Cases => F.IsNotEmpty.AllScenarios.ToFluentCases(s => s.Name switch
        {
    ...
    {
        public static TheoryData<FluentCase<(IDictionary<string, int>? dictionary, string key)>> Cases => F.HasKey.AllScenarios.ToFluentCases(s => s.Name switch
        {
    ...
    {
        public static TheoryData<FluentCase<(IDictionary<string, int>? dictionary, int value)>> Cases => F.HasValue.AllScenarios.ToFluentCases(s => s.Name switch
        {
            _ when s.IsValid => new FluentExpected(true),
    ...
    {
        public static TheoryData<FluentCase<(IDictionary<string, int>? dictionary, string key, int value)>> Cases => F.HasKeyValue.AllScenarios.ToFluentCases(s => s.Name switch
        {
            _ when s.IsValid => new FluentExpected(true),
    ...
    {
        public static TheoryData<FluentCase<(IDictionary<string, int>? dictionary, Func<string, bool> predicate)>> Cases => F.HasAnyKey.AllScenarios.ToFluentCases(s => s.Name switch
        {
            _ when s.IsValid => new FluentExpected(true),
    ...
    {
        public static TheoryData<FluentCase<(IDictionary<string, int>? dictionary, Func<int, bool> predicate)>> Cases => F.HasAnyValue.AllScenarios.ToFluentCases(s => s.Name switch
        {
            _ when s.IsValid => new FluentExpected(true),
    ...
    {
        public static TheoryData<FluentCase<(IDictionary<string, int>? dictionary, Func<string, int, bool> predicate)>> Cases => F.HasAnyItem.AllScenarios.ToFluentCases(s => s.Name switch
        {
            _ when s.IsValid => new FluentExpected(true),
    ...
    public static class OverloadResolution
    {
        ...
        [
            ...
            new("Empty-IRuleBuilder", static () => { var validator = new InlineValidator<Model>(); IRuleBuilder<Model, IDictionary<string, int>?> rb = validator.RuleFor(x => x.Dict); rb.Empty(); rb.Empty(); return validator.Validate(new Model { Dict = new Dictionary<string, int> { { "a", 1 } } }); }, new FluentExpected(false)),
            ...
            new("NotEmpty-IRuleBuilder", static () => { var validator = new InlineValidator<Model>(); IRuleBuilder<Model, IDictionary<string, int>?> rb = validator.RuleFor(x => x.Dict); rb.NotEmpty(); rb.NotEmpty(); return validator.Validate(new Model { Dict = new Dictionary<string, int>() }); }, new FluentExpected(false))
        ];

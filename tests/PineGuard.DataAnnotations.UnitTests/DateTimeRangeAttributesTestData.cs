...
public static class DateTimeRangeAttributesTestData
{
    ...
    private static DateTimeRange Range(int startDay, int endDay) =>
        new(new DateTime(2020, 1, startDay), new DateTime(2020, 1, endDay));

    // Chronological() — exclusive, start must be strictly before end
    public static class ChronologicalDateTimeRange
    {
    ...
    // Overlapping("2020-01-15T00:00:00", "2020-01-25T00:00:00") — range2 = [15, 25], exclusive
    public static class OverlappingDateTimeRange
    {
    ...
    // NotOverlapping("2020-01-15T00:00:00", "2020-01-25T00:00:00") — range2 = [15, 25], exclusive
    public static class NotOverlappingDateTimeRange
    {
    ...
    // Contains("2020-01-15T00:00:00") — inclusive
    public static class ContainsDateTimeRange
    {
    ...
    // NotContains("2020-01-15T00:00:00") — inclusive
    public static class NotContainsDateTimeRange
    {

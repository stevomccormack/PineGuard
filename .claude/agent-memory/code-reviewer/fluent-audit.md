...
- `[Theory] [InlineData(0)]` with `int _` dummy param: FluentDictionaryExtensions + FluentReadOnlyDictionary Tests use this for IRuleBuilderOptions smoke tests — [Fact] is correct, [InlineData] with dummy violates item 5

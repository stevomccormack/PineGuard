...
# Agent: Run Scoped Git Commits (Solution) (tools/git)
...
2. Limit execution strictly to the $(System.Collections.Hashtable.arg) scope (e.g., -Solution -AutoMessage and -IncludeTests if applicable).

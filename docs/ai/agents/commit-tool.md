<!-- metadata_header
type: agent
id: agent-commit-tools
version: 1.0
-->

# Agent: Run Scoped Git Commits (Tools) (tools/git)
...
2. Limit execution strictly to the $(System.Collections.Hashtable.arg) scope (e.g., -Tools -AutoMessage and -IncludeTests if applicable).

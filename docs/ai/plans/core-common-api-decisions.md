...
**`src/PineGuard.Core/Utils/BufferUtility.cs:17`** - severity **minor** - `naming`
...
**`src/PineGuard.Core/Rules/StringRules.cs:286`** - severity **info** - `naming`
...
**`src/PineGuard.Core/MustClauses/MustResult.cs:80`** - severity **minor** - `api-consistency`
...
**`src/PineGuard.Core/Common/DateOnlyRange.cs:68`** - severity **minor** - `api-consistency`
...
**`src/PineGuard.Core/Common/TimeOnlyRange.cs:9`** - severity **minor** - `api-consistency`
...
**`src/PineGuard.Core/Common/DateTimeRange.cs:109`** - severity **info** - `api-consistency`
...
**`src/PineGuard.Core/Rules/StringRules.NumberTypes.cs:38`** - severity **minor** - `thread-safety`
...
**`src/PineGuard.Core/Common/Enumeration.cs:61`** - severity **minor** - `edge-case`
...
**`src/PineGuard.Core/Common/Enumeration.cs:74`** - severity **minor** - `performance`
...
**`src/PineGuard.Core/Utils/OwaspUtility.cs:18`** - severity **minor** - `layering`
...
**`src/PineGuard.Core/Utils/StringUtility.Casing.cs:176`** - severity **minor** - `api-consistency`
...
**`src/PineGuard.Core/Rules/StringRules.NumberTypes.cs:21`** - severity **info** - `api-consistency`
...
**`src/PineGuard.Core/Rules/PhoneRules.cs:14`** - severity **major** - `doc-drift`

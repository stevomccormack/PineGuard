...
| [Rename Codex Skills](rename-codex-skills/SKILL.md) | `pineguard.skill.rename-codex-skills` | Strip Codex's `source-command-` prefix from generated `.agents/skills/` folders and commit them |
...
| [rename-codex-skills](../../../.claude/skills/rename-codex-skills/SKILL.md) | `rename-codex-skills` | Codex skill rename + scoped commit |
...
| [rename-codex-skills](../../../.github/skills/rename-codex-skills/SKILL.md) | `rename-codex-skills` | Codex skill rename + scoped commit |
...
| [rename-codex-skills](../../../.agents/skills/rename-codex-skills/SKILL.md) | `rename-codex-skills` | Codex skill rename + scoped commit |
...
under a `source-command-` prefix that is gitignored. `/rename-codex-skills`
(`tools/codex/Rename-CodexSkills.ps1`) promotes those to bare command names

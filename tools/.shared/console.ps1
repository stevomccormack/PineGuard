...
.DESCRIPTION
    ...
    differing names and colours) in tools/github/Run-Release.ps1, Set-GithubRuleset.ps1,
    tools/nuget/Unpublish-NugetPrerelease.ps1, and tools/clean/Test-StructuralIntegrity.ps1 (F-37). Write-Fail only

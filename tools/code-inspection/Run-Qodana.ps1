...
.PARAMETER Scope
    ...
    Valid values: Core, MustClauses, GuardClauses, FluentValidation, DataAnnotations, Options, DependencyInjection, ErrorOr, FluentResults, OneOf, Testing, All.
    Default: Core.
...
[CmdletBinding()]
param(
    [ValidateSet('Core', 'MustClauses', 'GuardClauses', 'FluentValidation', 'DataAnnotations', 'Options', 'DependencyInjection', 'ErrorOr', 'FluentResults', 'OneOf', 'Testing', 'All')] [string] $Scope = 'Core',

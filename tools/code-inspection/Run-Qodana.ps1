...
.PARAMETER Scope
    ...
    Valid values: Core, MustClauses, GuardClauses, FluentValidation, DataAnnotations, Testing, All.
    Default: Core.
...
[CmdletBinding()]
param(
    [ValidateSet('Core', 'MustClauses', 'GuardClauses', 'FluentValidation', 'DataAnnotations', 'Testing', 'All')] [string] $Scope = 'Core',

...
.PARAMETER Scope
    ...
    Valid values: Core, MustClauses, GuardClauses, FluentValidation, DataAnnotations, Options, Testing, All.
    Default: Core.
...
[CmdletBinding()]
param(
    [ValidateSet('Core', 'MustClauses', 'GuardClauses', 'FluentValidation', 'DataAnnotations', 'Options', 'Testing', 'All')] [string] $Scope = 'Core',

...
.PARAMETER Scope
    ...
    Valid values: Core, MustClauses, GuardClauses, FluentValidation, DataAnnotations, Options, DependencyInjection, ErrorOr, FluentResults, OneOf, MediatR, Testing, All.
    Default: Core.

...
$any = $Agent -or $Core -or $MustClauses -or $GuardClauses -or $FluentValidation -or $DataAnnotations -or $Options -or $ErrorOr -or $FluentResults -or $OneOf -or $Testing -or $Docs -or $Tools -or $Solution
if (-not $any) {

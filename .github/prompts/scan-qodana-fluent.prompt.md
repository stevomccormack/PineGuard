---
name: scan-qodana-fluent
description: "Run JetBrains Qodana for FluentValidation"
agent: reviewer
argument-hint: Optional scope or inspection focus.
---
Read and execute [scan-qodana-fluent.md](../../docs/ai/agents/scan-qodana-fluent.md).

...
1. Run coverage (console + JSON output, no HTML): `pwsh -NoProfile -ExecutionPolicy Bypass -File "./tools/code-coverage/Run-CodeCoverage.ps1" -Mode GenerateAndAnalyze -Scope [ProjectName] -Top 30 -Isolated -SkipHtml`
